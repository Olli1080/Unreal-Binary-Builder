...
set appcast_release=https://github.com/Olli1080/Unreal-Binary-Builder/releases/download/%appcast_version%/UnrealBinaryBuilder.v%appcast_version%.zip
set appcast_changelog=https://raw.githubusercontent.com/Olli1080/Unreal-Binary-Builder/master/CHANGELOG.md
